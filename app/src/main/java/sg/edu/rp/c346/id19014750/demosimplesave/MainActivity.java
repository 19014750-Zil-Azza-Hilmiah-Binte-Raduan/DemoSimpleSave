package sg.edu.rp.c346.id19014750.demosimplesave;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onPostResume() {
        super.onPostResume();
        // Step 1: Obtain the SharedPreference instance
        SharedPreferences pref = getPreferences(MODE_PRIVATE);
        // Step 2: Retrieve the saved data from the SharedPreferences with default value is no matching data
